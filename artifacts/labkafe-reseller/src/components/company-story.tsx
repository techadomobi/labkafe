...
const milestones = [
  {
    ...
    body: "Labscode was established with a simple mission: to provide affordable, high-quality laboratory equipment to schools and colleges across India that were underserved by traditional suppliers.",
  ...
  },
  {
    ...
    body: "Recognizing the need for a distributed sales network, Labscode launched its official reseller partner program — starting with 25 partners across 5 states.",
  ...
  },
  {
    ...
    body: "Labscode crossed 100 reseller partners and expanded operations to 15 states, establishing regional fulfilment hubs in Delhi, Mumbai, Bengaluru, and Chennai.",
  ...
  },
  {
    ...
    body: "Today, Labscode stands as India's most trusted lab solutions company with 500+ active resellers, 10,000+ products, and a presence in 28+ states — and we're just getting started.",
